...
# Initial Questions
project_type = input("\nWhat is this project for? (Ex: Hackathon, Startup, Personal Website, etc.)")
project_interest = input("\nDo you have a topic of interest in mind? (Ex: Sports, Law, Math, etc.)")
project_technical = input("\nWhat sort of technical skills do you want to work with (If Any)? (Ex: Data Visualizations, Machine Learning, Full Stack, NONE, etc.)")
project_potential = input("\nDo you have a potential idea in mind or nothing at all?")
project_additional = input("\nDo you have any additional information that you want that will be helpful to create a project idea for you?")
